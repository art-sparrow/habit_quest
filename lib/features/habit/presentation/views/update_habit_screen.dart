...
class UpdateHabitScreen extends StatefulWidget {
  const UpdateHabitScreen({required this.habitModel, super.key});
...
class _UpdateHabitScreenState extends State<UpdateHabitScreen> {
  ...
  void initState() {
    ...
    // Assign values
    nameController.text = widget.habitModel.name;
    descriptionController.text = widget.habitModel.description;
    _selectedEndDate = widget.habitModel.endDate;
    selectedFrequency = widget.habitModel.frequency;
    super.initState();
  }
  ...
  void _updateHabit() {
    if (_formKey.currentState!.validate()) {
      ...
      // Save habit model with form data
      final habitModel = HabitModel(
      ...
      // Trigger update habit event
      context.read<HabitBloc>().add(UpdateHabitRequested(habitModel));
    }
  }
  ...
  void _deleteHabit() {
    if (_formKey.currentState!.validate()) {
      // Trigger delete habit event
      context.read<HabitBloc>().add(
            DeleteHabitRequested(
        ...
        listener: (context, state) {
          ...
          if (state is HabitsLoaded) {
            ...
            NotificationService().showNotification(
              ...
              message: 'Habit was modified successfully!',
            );
